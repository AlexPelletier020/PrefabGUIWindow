...
namespace Silverback.EditorTools
{
	...
	{
		public static Type GetValidatorFor(string scenePath, bool validateType = false)
		{
			if (validateType)
			{
		...
		{
			return (SceneValidatorAttribute)sceneValidatorClass
				.GetCustomAttributes(typeof(SceneValidatorAttribute), false)
				.FirstOrDefault();
		}
